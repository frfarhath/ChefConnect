...
import { faEye, faBookmark } from '@fortawesome/free-solid-svg-icons'; // Import icons
...
function UserRecipes() {
  ...
  return (
    <div className="container mx-auto mt-6">
      <h2 className="text-2xl font-bold mb-6 text-center text-[#cc133d]">Recipies Shared</h2>
          ...
          <div key={category.id} className="bg-white text-black rounded-lg shadow-lg transform transition-transform hover:-translate-y-2 overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between items-center">
                ...
                {/* Unsave Button */}
                <button className="bg-[#691a36] hover:bg-red-600 text-white py-2 px-4 rounded flex items-center">
                  <FontAwesomeIcon icon={faBookmark} className="mr-2" /> Save
                </button>
              </div>
            </div>
          </div>
